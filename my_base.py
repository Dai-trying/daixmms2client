...
class Ui_EditId3Info(object):
    def setupUi(self, EditId3Info):
        ...
        EditId3Info.resize(280, 260)
        EditId3Info.setMinimumSize(QtCore.QSize(280, 260))
        EditId3Info.setMaximumSize(QtCore.QSize(280, 260))
        EditId3Info.setWindowTitle("Edit Id3 Tag Info")
        self.gridLayout = QtWidgets.QGridLayout(EditId3Info)
        self.gridLayout.setObjectName("gridLayout")
        self.ml_id_label = QtWidgets.QLabel(EditId3Info)
        self.ml_id_label.setMinimumSize(QtCore.QSize(0, 20))
        self.ml_id_label.setMaximumSize(QtCore.QSize(16777215, 20))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.ml_id_label.setFont(font)
        self.ml_id_label.setAlignment(QtCore.Qt.AlignCenter)
        self.ml_id_label.setObjectName("ml_id_label")
        self.ml_id_label.setText("Media Library Id")
        self.gridLayout.addWidget(self.ml_id_label, 0, 0, 1, 2)
        self.title_label = QtWidgets.QLabel(EditId3Info)
        self.title_label.setMinimumSize(QtCore.QSize(90, 16))
        font = QtGui.QFont()
        ...
        self.title_lineEdit = QtWidgets.QLineEdit(EditId3Info)
        self.title_lineEdit.setObjectName("title_lineEdit")
        self.gridLayout.addWidget(self.title_lineEdit, 1, 1, 1, 1)
        self.artist_label = QtWidgets.QLabel(EditId3Info)
        self.artist_label.setMinimumSize(QtCore.QSize(90, 16))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.artist_label.setFont(font)
        self.artist_label.setObjectName("artist_label")
        self.artist_label.setText("Song Artist")
        self.gridLayout.addWidget(self.artist_label, 2, 0, 1, 1)
        self.artist_lineEdit = QtWidgets.QLineEdit(EditId3Info)
        self.artist_lineEdit.setObjectName("artist_lineEdit")
        self.gridLayout.addWidget(self.artist_lineEdit, 2, 1, 1, 1)
        self.track_label = QtWidgets.QLabel(EditId3Info)
        self.track_label.setMinimumSize(QtCore.QSize(90, 16))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.track_label.setFont(font)
        self.track_label.setObjectName("track_label")
        self.track_label.setText("Track Number")
        self.gridLayout.addWidget(self.track_label, 3, 0, 1, 1)
        self.track_spinBox = QtWidgets.QSpinBox(EditId3Info)
        self.track_spinBox.setObjectName("track_spinBox")
        self.gridLayout.addWidget(self.track_spinBox, 3, 1, 1, 1)
        self.album_label = QtWidgets.QLabel(EditId3Info)
        self.album_label.setMinimumSize(QtCore.QSize(90, 16))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.album_label.setFont(font)
        self.album_label.setObjectName("album_label")
        self.album_label.setText("Album Title")
        self.gridLayout.addWidget(self.album_label, 4, 0, 1, 1)
        self.album_lineEdit = QtWidgets.QLineEdit(EditId3Info)
        self.album_lineEdit.setObjectName("album_lineEdit")
        self.gridLayout.addWidget(self.album_lineEdit, 4, 1, 1, 1)
        self.disc_label = QtWidgets.QLabel(EditId3Info)
        self.disc_label.setMinimumSize(QtCore.QSize(90, 16))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.disc_label.setFont(font)
        self.disc_label.setObjectName("disc_label")
        self.disc_label.setText("Disc Number")
        self.gridLayout.addWidget(self.disc_label, 5, 0, 1, 1)
        self.disc_spinBox = QtWidgets.QSpinBox(EditId3Info)
        self.disc_spinBox.setObjectName("spinBox_2")
        self.gridLayout.addWidget(self.disc_spinBox, 5, 1, 2, 1)
        self.performer_label = QtWidgets.QLabel(EditId3Info)
        self.performer_label.setMinimumSize(QtCore.QSize(90, 16))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.performer_label.setFont(font)
        self.performer_label.setObjectName("performer_label")
        self.performer_label.setText("Album Artist")
        self.gridLayout.addWidget(self.performer_label, 6, 0, 2, 1)
        self.performer_lineEdit = QtWidgets.QLineEdit(EditId3Info)
        self.performer_lineEdit.setObjectName("performer_lineEdit")
        self.gridLayout.addWidget(self.performer_lineEdit, 7, 1, 1, 1)
        self.genre_label = QtWidgets.QLabel(EditId3Info)
        self.genre_label.setMinimumSize(QtCore.QSize(90, 16))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.genre_label.setFont(font)
        self.genre_label.setObjectName("genre_label")
        self.genre_label.setText("Genre")
        self.gridLayout.addWidget(self.genre_label, 8, 0, 1, 1)

        self.genre_combo = QtWidgets.QComboBox(EditId3Info)
        self.genre_combo.setObjectName("genre_combo")

        self.gridLayout.addWidget(self.genre_combo, 8, 1, 1, 1)

        self.buttonBox = QtWidgets.QDialogButtonBox(EditId3Info)
        self.buttonBox.setOrientation(QtCore.Qt.Horizontal)
        self.buttonBox.setStandardButtons(QtWidgets.QDialogButtonBox.Cancel|QtWidgets.QDialogButtonBox.Ok)
        self.buttonBox.setObjectName("buttonBox")
        self.gridLayout.addWidget(self.buttonBox, 9, 0, 1, 2)

        self.buttonBox.accepted.connect(EditId3Info.accept)
        self.buttonBox.rejected.connect(EditId3Info.reject)
        QtCore.QMetaObject.connectSlotsByName(EditId3Info)